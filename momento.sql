...
VALUES (207,'Alexsander','Mendes','Alexsander.Mendes@momento.org', '947217813','2023-08-12', 9, 4000.00,101,6);

-- A administração está sem funcionários. Inclua alguns colegas de turma nesse departamento. 
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES (208,'João','Vitor','João.Vitor@momento.org', '927238293','2023-05-10', 3, 5000.00,101,1);
...
INSERT INTO funcionarios(funcionario_id,primeiro_nome,sobrenome,email,telefone,data_contratacao,ocupacao_id,salario,gerente_id,departamento_id) VALUES (210,'Thiago','Carlos','Thiago.Carlos@momento.org', '934527887','2023-05-10', 3, 5000.00,101,1);
...
INSERT INTO ocupacoes(ocupacao_id,ocupacao_nome,min_salario,max_salario) VALUES (22, 'Desenvolvedor', 5000.00, 12000.00);
